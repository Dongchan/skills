...
**언제 이 스킬 / 언제 다른 스킬:** 단일 단순 이미지·고해상도(2K+)·정밀 마스킹 편집·멀티 레퍼런스 합성은 [`gpt-image2`](#gpt-image2) 또는 [`gemini-3-pro-imagegen`](#gemini-3-pro-imagegen) 가 더 낫습니다. 동시에 3장 이상을 빠르게 만들어야 하는 모든 경우에 `codex-image` 가 가장 빠릅니다.
